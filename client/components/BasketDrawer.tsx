          ...
          <div className="h-full flex flex-col bg-white shadow-2xl animate-in slide-in-from-right duration-300">
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6">
              {basket.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center opacity-40">
                  ...
                  <h3 className="text-xl font-bold text-kiwi-dark">Basket is empty</h3>
            ...
            {basket.length > 0 && (
              <div className="p-6 border-t border-gray-100 bg-gray-50/80">
                <button
                  onClick={() => setIsDrawerOpen(false)}
                  className="w-full py-4 bg-kiwi-dark text-white rounded-2xl font-black text-lg shadow-xl shadow-kiwi-dark/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 mb-3 border-none cursor-pointer"
                >
